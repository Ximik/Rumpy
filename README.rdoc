...
Rumpy is some kind of framework to make up your own jabber bot quickly. It uses {ActiveRecord}[https://github.com/rails/rails/tree/master/activerecord] and {XMPP4R}[http://home.gna.org/xmpp4r/].
...
Look {example CuteBot}[https://github.com/MPogoda/CuteBot] and {yatodo}[https://github.com/MPogoda/yatodo].
